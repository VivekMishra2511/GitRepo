...
public class TrustAccountReportEmoneyDetailWeb extends Common{
	 ...
	 */
	public TrustAccountReportEmoneyDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days Emoney Detail
	 * @creation date 21/12/2018
	 */
	public void searchEmoneyDetail() {
		sendTextInStartDate();
		sendTextInEndDate();
	 ...
	 * @creation date 21/12/2018
	 */
	public boolean verifysearchEmoneyDetail(){
