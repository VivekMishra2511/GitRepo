...
public class AgentThresholdExternalWeb extends Common {
	...
	By drpSearchProfileName = By.id("cmbTreeProfileID");
	...
	By drpTreeLevel = By.id("TreeLevelID");
	...
	public AgentThresholdExternalWeb(WebDriver driver) {
		this.driver = driver;
	}

	/**
	 * @author kutbuddin.compounder send text in AgentExternal Threshold
	 *         productName field
	 * @param productName
	...
	/**
	 * @author kutbuddin.compounder select value from Agent-Threshold External
	 *         productName drop down
	 * @param vendorName
	 * @creation date 12/11/2018
	 */
	...
	/**
	 * @author kutbuddin.compounder send text in Agent Threshold External
	 ...
	 */
	public void filterSearch(String thresholdName, String moduleName, String servicename, String operatorName,
			String productName, String profileName, String status) {
		commonFilterSearch();
		sendTextInSerachThresholdName(thresholdName);
		selectSearchModuleName(moduleName);
		selectSearchServiceName(servicename);
		selectSearchOperatorName(operatorName);
		selectSearchProductName(productName);
		selectSearchProfileName(profileName);
		selectSearchStatus(status);
		clickOnFilterSearchBtn();
	}

	/**
	 * @author kutbuddin.compounder to add Agent-Threshold External
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 12/11/2018
	 */
	public void addAgentThresholdExternal(Map<Object, Object> map, List<Object> keys) {
		...
		if (!verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			...
			if (!map.get(keys.get(7)).toString().isEmpty()) {
				selectTreeName(map.get(keys.get(7)).toString());
			}
			if (!map.get(keys.get(8)).toString().isEmpty()) {
				selectTreeLevel(map.get(keys.get(8)).toString());
			}
			selectProfileName(map.get(keys.get(3)).toString());
			selectStatus(map.get(keys.get(5)).toString());
			String[] nonKyctransactionCount = map.get(keys.get(9)).toString().split(":");
			String[] nonKyctransactionValue = map.get(keys.get(10)).toString().split(":");
			String[] mediumKyctransactionCount = map.get(keys.get(11)).toString().split(":");
			String[] mediumKyctransactionValue = map.get(keys.get(12)).toString().split(":");
			String[] fullKyctransactionCount = map.get(keys.get(13)).toString().split(":");
			String[] fullKyctransactionValue = map.get(keys.get(14)).toString().split(":");
	...
	/**
	 * @author kutbuddin.compounder to Edit Agent-Threshold External
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 12/11/2018
	 */
	public void editAgentThresholdExternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(5)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			...
			clickOnEditBtn();
			selectStatus(map.get(keys.get(15)).toString());
			String[] nonKyctransactionCount = map.get(keys.get(9)).toString().split(":");
			String[] nonKyctransactionValue = map.get(keys.get(10)).toString().split(":");
			String[] mediumKyctransactionCount = map.get(keys.get(11)).toString().split(":");
			String[] mediumKyctransactionValue = map.get(keys.get(12)).toString().split(":");
	 ...
	 *            - excel header
	 * @creation date 24/10/2018
	 * @return true if AgentExternal Threshold added successfully
	 */
	public boolean verifyAgentThresholdExternalAdded(Map<Object, Object> map, List<Object> keys) {
		...
		By treeName = By.xpath(" //label[normalize-space(text())='" + ConstantsFile.TREE
				+ "']//following-sibling :: div[contains(text() , '" + map.get(keys.get(7)).toString() + "')]");
		By treeLevel = By.xpath(" //label[normalize-space(text())='" + ConstantsFile.TREE_LEVEL
				+ "']//following-sibling :: div[contains(text() , '" + map.get(keys.get(8)).toString() + "')]");
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(5)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
	 ...
	 *            - excel header
	 * @creation date 24/10/2018
	 * @return true if AgentExternal Threshold edited successfully
	 */
	public boolean verifyAgentThresholdExternalEdited(Map<Object, Object> map, List<Object> keys) {
		By productName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.PRODUCT_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(1)).toString() + "']");
		By operatorName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.OPERATOR_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(6)).toString() + "']");
		...
		By profileName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.PROFILE_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(3)).toString() + "']");
		By Status = By.xpath("//label[normalize-space(text())='" + ConstantsFile.STATUS
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(15)).toString() + "']");
		By treeName = By.xpath(" //label[normalize-space(text())='" + ConstantsFile.TREE
				+ "']//following-sibling :: div[contains(text() , '" + map.get(keys.get(7)).toString() + "')]");
		By treeLevel = By.xpath(" //label[normalize-space(text())='" + ConstantsFile.TREE_LEVEL
				+ "']//following-sibling :: div[contains(text() , '" + map.get(keys.get(8)).toString() + "')]");
	...
	/**
	 * @author Kutbuddin.compounder to verify AgentExternalThreshold deleted?
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 24/10/2018
	 * @return true if AgentExternalThreshold deleted successfully
	 */
	public boolean deleteAgentThresholdExternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(5)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			...
			String string = "AgentExternalThreshold already deleted";
			log("</br><b style='color:#02563d'>" + string + "</b>");
		}
		return false;
	}

	public boolean verifyAgentExternalThresholdDeleted(Map<Object, Object> map, List<Object> keys) {
		if (verifyFilterBtn()) {
	 ...
	 * @return true if AgentExternalThreshold Log successfully Verified
	 */
	public boolean verifyAgentExternalThresholdLog(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(15)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
	...
	/**
	 * @author dishant.doshi to sort agent external threshold
	 * @param map
	 *            - for excel data
	 * @param mapKeys
	 *            - for excel header
