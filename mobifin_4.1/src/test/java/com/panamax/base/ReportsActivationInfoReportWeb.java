...
public class ReportsActivationInfoReportWeb extends Common{
	 ...
	 */
	public ReportsActivationInfoReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days activationInfo report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify  activationinfo report table
	 * @creation date 27/12/2018
	 */
	public boolean verifySearchActivationInfoReport() {
