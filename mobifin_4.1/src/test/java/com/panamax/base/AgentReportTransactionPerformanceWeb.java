...
public class AgentReportTransactionPerformanceWeb extends Common {
	By startDateLabel = By
			.xpath("//*[contains(@class,'panel-title text-muted bottom') and normalize-space(text())='Start Date']");
	 ...
	 */
	public AgentReportTransactionPerformanceWeb(WebDriver driver) {
		this.driver = driver;
	}

	/**
	 * @author shivani.patel Select in treeName In Filter Search
	 * @param treeName
	 * @creation date 19/12/2018
	 */
	...
	/**
	 * @author shivani.patel Select in agentLevel In Filter Search
	 * @param agentLevel
	 * @creation date 19/12/2018
	 */
	public void selectAgentLevelInFilterSearch(String agentLevel) {
		selectFromDropdown(drpTreeLevel, agentLevel);
	}

	/**
	 * @author shivani.patel Select in profileName In Filter Search
	 * @param profileName
	 * @creation date 19/12/2018
	 */
	...
	/**
	 * @author shivani.patel Select in kYCStatus In Filter Search
	 * @param kYCStatus
	 * @creation date 19/12/2018
	 */
	...
	/**
	 * @author shivani.patel Select in state In Filter Search
	 * @param state
	 * @creation date 19/12/2018
	 */
	...
	/**
	 * @author shivani.patel Select in transactionType In Filter Search
	...
	/**
	 * @author shivani.patel Select in groupBy In Filter Search
	 * @param groupBy
	 * @creation date 18/12/2018
	 */
	...
	/**
	 * @author shivani.patel Select in viewType In Filter Search
	 * @param viewType
	 * @creation date 18/12/2018
	 */
	...
	/**
	 * @author shivani.patel Send Text in productName Field In Filter Search
	 * @param productName
	 * @creation date 18/12/2018
	 */
	...
	/**
	 * @author shivani.patel use for Filter Search Add Field
	 * @param treeName,AgentLevel,ProfileName,KYCStatus,State,ProductName,TransactionType,GroupBy,ViewType
	 * @creation date 19/12/2018
	 */
	public void filterSearch(String TreeName, String AgentLevel, String ProfileName, String KYCStatus, String State,
			String ProductName, String TransactionType, String GroupBy, String ViewType) {
		commonFilterSearch();
		if (!TreeName.equals(""))
			selectTreeNameInFilterSearch(TreeName);
		if (!AgentLevel.equals(""))
			selectAgentLevelInFilterSearch(AgentLevel);
	...
	/**
	 * @author shivani.patel Search last 30 days Onboarding Performance
	 * @creation date 19/12/2018
	 */
	public void searchTransactionPerformance(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(getMapKeys(map).get(0)).toString(), map.get(getMapKeys(map).get(1)).toString(),
				...
				map.get(getMapKeys(map).get(6)).toString(), map.get(getMapKeys(map).get(7)).toString(),
				map.get(getMapKeys(map).get(8)).toString());
		if(verifyToolTip()){
			verifyFalse(true);
		}
	}
	...
	/**
	 * @author shivani.patel Use for verify Report table
	 * @creation date 19/12/2018
	 */
