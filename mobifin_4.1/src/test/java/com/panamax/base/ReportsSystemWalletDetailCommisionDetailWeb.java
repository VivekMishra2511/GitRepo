...
public class ReportsSystemWalletDetailCommisionDetailWeb extends Common{
	 ...
	 */
	public ReportsSystemWalletDetailCommisionDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days system wallet details CommisionDetail report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify CommisionDetail table
	 * @creation date 27/12/2018
	 */
	public boolean verifysearchCommisionDetail() {
