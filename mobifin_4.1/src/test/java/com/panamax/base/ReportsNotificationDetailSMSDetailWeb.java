...
public class ReportsNotificationDetailSMSDetailWeb extends Common{
	 ...
	 */
	public ReportsNotificationDetailSMSDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days notification detail SMSDetail report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify SMSDetail table
	 * @creation date 27/12/2018
	 */
	public boolean verifysearchSMSDetail() {
