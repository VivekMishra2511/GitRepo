...
public class AgentReportOnboardingPerformanceWeb extends Common {
	 ...
	 */
	public AgentReportOnboardingPerformanceWeb(WebDriver driver) {
		this.driver = driver;
	}
	 ...
	 * @creation date 19/12/2018
	 */
	public void selectTreeLevelInFilterSearch(String agentLevel) {
	...
	/**
	 * @author shivani.patel Select in channelOfRegistration In Filter Search
	 ...
	 * @param treeName,AgentLevel,ProfileName,KYCStatus,State,ChannelOfRegistration,GroupBy
	 * @creation date 19/12/2018
	 */
	public void filterSearch(String TreeName, String AgentLevel, String ProfileName, String KYCStatus, String State,
			String ChannelOfRegistration, String GroupBy) {
		commonFilterSearch();
		if (!TreeName.equals(""))
			selectTreeNameInFilterSearch(TreeName);
		if (!AgentLevel.equals(""))
			selectTreeLevelInFilterSearch(AgentLevel);
