...
public class ReportsSystemWalletDetailNonRegisterDetailWeb extends Common{
	 ...
	 */
	public ReportsSystemWalletDetailNonRegisterDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days system wallet details NonRegisterDetail report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify NonRegisterDetail table
	 * @creation date 27/12/2018
	 */
	public boolean verifysearchNonRegisterDetail() {
