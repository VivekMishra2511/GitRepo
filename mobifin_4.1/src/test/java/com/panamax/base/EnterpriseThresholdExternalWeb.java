...
public class EnterpriseThresholdExternalWeb extends Common {
	...
	public EnterpriseThresholdExternalWeb(WebDriver driver) {
		this.driver = driver;
	}

	/**
	 * @author kutbuddin.compounder send text in EnterpriseExternal Threshold
	 *         productName field
	 * @param productName
	...
	/**
	 * @author kutbuddin.compounder send text in Enterprise Threshold External
	...
	/**
	 * @author kutbuddin.compounder to add Enterprise-Threshold External
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 ...
	 * @update date 02/07/2019
	 */
	public void addEnterpriseThresholdExternal(Map<Object, Object> map, List<Object> keys) {
	...
	/**
	 * @author kutbuddin.compounder to Edit Enterprise-Threshold External
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 ...
	 * @update date 02/07/2019
	 */
	public void editEnterpriseThresholdExternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(5)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
	 ...
	 *            - excel header
	 * @creation date 24/10/2018
	 * @return true if EnterpriseExternal Threshold added successfully
	 * @update by dishant.doshi
	 * @update date 02/07/2019
	 */
	public boolean verifyEnterpriseThresholdExternalAdded(Map<Object, Object> map, List<Object> keys) {
	 ...
	 *            - excel header
	 * @creation date 24/10/2018
	 * @return true if EnterpriseExternal Threshold edited successfully
	 * @update by dishant.doshi
	 * @update date 02/07/2019
	 */
	public boolean verifyEnterpriseThresholdExternalEdited(Map<Object, Object> map, List<Object> keys) {
		By productName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.PRODUCT_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(1)).toString() + "']");
		By operatorName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.OPERATOR_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(6)).toString() + "']");
	...
	/**
	 * @author Kutbuddin.compounder to verify EnterpriseExternalThreshold
	 *         deleted?
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 24/10/2018
	 * @return true if EnterpriseExternalThreshold deleted successfully
	 */
	public boolean deleteEnterpriseThresholdExternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(5)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			...
			String string = "EnterpriseExternalThreshold already deleted";
			log("</br><b style='color:#02563d'>" + string + "</b>");
		}
		return false;
	}

	public boolean verifyEnterpriseExternalThresholdDeleted(Map<Object, Object> map, List<Object> keys) {
		if (verifyFilterBtn()) {
	 ...
	 * @return true if EnterpriseExternalThreshold Log successfully Verified
	 */
	public boolean verifyEnterpriseExternalThresholdLog(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(2)).toString(), map.get(keys.get(4)).toString(),
				map.get(keys.get(6)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(3)).toString(),
				map.get(keys.get(13)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
	...
	/**
	 * @author dishant.doshi to sort enterprise external threshold
	 * @param map
	 *            - for excel data
	 * @param mapKeys
	 *            - for excel header
