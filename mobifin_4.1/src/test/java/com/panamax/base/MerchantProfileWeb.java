...
/**
 * @author dishant.doshi Actions of Merchant - Profile
 * @creation date 15/11/2018
 */
public class MerchantProfileWeb extends Common {
	 ...
	 * @creation date 15/11/2018
	 */
	public MerchantProfileWeb(WebDriver driver) {
		this.driver = driver;
	}
			...
			if (!map.get(mapKeys.get(6)).toString().equals("")) {
				...
				for (int n = 0; n < nonKYCFields.length; n++) {
					...
					if (!map.get(mapKeys.get(7)).toString().equals("")) {
						String[] nonField = nonKYCField[1].split(",");
						for (int a = 0; a < nonField.length; a++) {
							By nonKYC = By.xpath("//*[normalize-space(text())='" + nonKYCField[0]
									+ "']//preceding-sibling::td[normalize-space(text())='" + nonField[a]
	...
	/**
	 * @author dishant.doshi to sort merchant profile
	 * @param map
	 *            - for excel data
	 * @param mapKeys
	 *            - for excel header
