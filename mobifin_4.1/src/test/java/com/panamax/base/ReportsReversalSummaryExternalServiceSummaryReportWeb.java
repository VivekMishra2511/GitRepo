...
public class ReportsReversalSummaryExternalServiceSummaryReportWeb extends Common{
	 ...
	 */
	public ReportsReversalSummaryExternalServiceSummaryReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days Reversal Summary ExternalServiceSummaryReport
	 * @creation date 24/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify ExternalServiceSummaryReport table
	 * @creation date 24/12/2018
	 */
