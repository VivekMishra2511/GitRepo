...
public class ReportsNotificationDetailEmailDetailWeb extends Common{
	 ...
	 */
	public ReportsNotificationDetailEmailDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days notification detail emailDetail report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify emailDetail table
	 * @creation date 27/12/2018
	 */
	public boolean verifysearchEmailDetail() {
