...
public class TrustAccountReportTransactionDetailWeb extends Common{
	 ...
	 */
	public TrustAccountReportTransactionDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days transaction details
	 * @creation date 21/12/2018
	 */
