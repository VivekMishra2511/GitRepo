...
public class ReportsVendorTransactionDetailWeb extends Common{
	 ...
	 */
	public ReportsVendorTransactionDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days vendor transaction detail report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify  vendor transaction detail table
	 * @creation date 27/12/2018
	 */
	public boolean verifySearchVendorTransactionDetail() {
