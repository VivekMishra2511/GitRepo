...
public class CustomerReportTransactionPerformanceWeb extends Common{
	 ...
	 */
	public CustomerReportTransactionPerformanceWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 ...
	 * @param ProfileName,KYCStatus,State,ProductName,TransactionType,GroupBy,ViewType
	 * @creation date 20/12/2018
	 */
	public void filterSearch(String ProfileName,String KYCStatus,String TransactionType,String ProductName,String State,String GroupBy,String ViewType) {
		commonFilterSearch();
