...
public class TrustAccountReportEmoneySummaryWeb extends Common{
	 ...
	 */
	public TrustAccountReportEmoneySummaryWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days Emoney Summary
	 * @creation date 24/12/2018
	 */
	public void searchEmoneySummary() {
		sendTextInStartDate();
		sendTextInEndDate();
	 ...
	 * @creation date 24/12/2018
	 */
	public boolean verifysearchEmoneySummary(){
