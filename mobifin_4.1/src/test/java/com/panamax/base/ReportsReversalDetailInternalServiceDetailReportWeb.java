...
public class ReportsReversalDetailInternalServiceDetailReportWeb extends Common{
	 ...
	 */
	public ReportsReversalDetailInternalServiceDetailReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days Reversal Detail InternalServiceDetailReport
	 * @creation date 24/12/2018
	 */
