...
public class TrustAccountReportTransactionSummaryWeb extends Common{
	 ...
	 */
	public TrustAccountReportTransactionSummaryWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days transaction summary
	 * @creation date 21/12/2018
	 */
