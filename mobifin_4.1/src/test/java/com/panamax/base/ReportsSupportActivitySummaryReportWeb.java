...
public class ReportsSupportActivitySummaryReportWeb extends Common{
	 ...
	 */
	public ReportsSupportActivitySummaryReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days support activity summary report
	 * @creation date 28/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify  support activity summary report table
	 * @creation date 28/12/2018
	 */
	public boolean verifySearchSupportActivitySummaryReport() {
