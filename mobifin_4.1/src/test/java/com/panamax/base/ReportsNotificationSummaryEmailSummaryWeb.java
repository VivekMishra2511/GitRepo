...
public class ReportsNotificationSummaryEmailSummaryWeb extends Common{
	 ...
	 */
	public ReportsNotificationSummaryEmailSummaryWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days notification summary emailSummary report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify emailSummary table
	 * @creation date 27/12/2018
	 */
	public boolean verifysearchEmailSummary() {
