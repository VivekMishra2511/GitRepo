...
public class CustomerThresholdInternalWeb extends Common {
	...
	public CustomerThresholdInternalWeb(WebDriver driver) {
		this.driver = driver;
	}
	...
	/**
	 * @author kutbuddin.compounder send text in Customer Threshold Internal
	...
	/**
	 * @author kutbuddin.compounder to add Customer-Threshold Internal
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 06/11/2018
	 */
	public void addCustomerThresholdInternal(Map<Object, Object> map, List<Object> keys) {
	...
	/**
	 * @author kutbuddin.compounder to Edit Customer-Threshold Internal
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 06/11/2018
	 */
	public void editCustomerThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
	 ...
	 */
	public boolean verifyCustomerThresholdInternalAdded(Map<Object, Object> map, List<Object> keys) {
	 ...
	 */
	public boolean verifyCustomerThresholdInternalEdited(Map<Object, Object> map, List<Object> keys) {
		By thresholdName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.THRESHOLD_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(0)).toString() + "']");
		By profileName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.PROFILE_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(2)).toString() + "']");
	...
	/**
	 * @author Kutbuddin.compounder to verify CustomerInternalThreshold deleted?
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 7/11/2018
	 * @return true if CustomerInternalThreshold deleted successfully
	 */
	public boolean deleteCustomerThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
			...
			String string = "CustomerInternalThreshold already deleted";
	 ...
	 * @return true if CustomerInternalThreshold deleted successfully
	 */
	public boolean verifyCustomerInternalThresholdDeleted(Map<Object, Object> map, List<Object> keys) {
		if (verifyFilterBtn()) {
	 ...
	 * @return true if CustomerInternalThreshold Log successfully Verified
	 */
	public boolean verifyCustomerInternalThresholdLog(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(10)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
	...
	/**
	 * @author dishant.doshi to sort customer internal threshold
	 * @param map
	 *            - for excel data
	 * @param mapKeys
	 *            - for excel header
