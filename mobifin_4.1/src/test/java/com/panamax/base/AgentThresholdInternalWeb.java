...
public class AgentThresholdInternalWeb extends Common {
	...
	public AgentThresholdInternalWeb(WebDriver driver) {
		this.driver = driver;
	}

	/**
	 * @author kutbuddin.compounder send text in Agent Internal Threshold
	 *         productName field
	 * @param productName
	 * @creation date 12/11/2018
	 */
	...
	/**
	 * @author kutbuddin.compounder select value from Agent-Threshold Internal
	...
	/**
	 * @author kutbuddin.compounder send text in Agent Threshold Internal
	...
	/**
	 * @author kutbuddin.compounder to add Agent-Threshold Internal
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 12/11/2018
	 */
	public void addAgentThresholdInternal(Map<Object, Object> map, List<Object> keys) {
	...
	/**
	 * @author kutbuddin.compounder to Edit Agent-Threshold Internal
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 12/11/2018
	 */
	public void editAgentThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
	 ...
	 *            - excel header
	 * @creation date 12/11/2018
	 * @return true if Agent Internal Threshold added successfully
	 */
	public boolean verifyAgentThresholdInternalAdded(Map<Object, Object> map, List<Object> keys) {
	 ...
	 *            - excel header
	 * @creation date 12/11/2018
	 * @return true if Agent Internal Threshold edited successfully
	 */
	public boolean verifyAgentThresholdInternalEdited(Map<Object, Object> map, List<Object> keys) {
		By thresholdName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.THRESHOLD_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(0)).toString() + "']");
		By profileName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.PROFILE_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(2)).toString() + "']");
	...
	/**
	 * @author Kutbuddin.compounder to verify AgentInternalThreshold deleted?
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 12/11/2018
	 * @return true if AgentInternalThreshold deleted successfully
	 */
	public boolean deleteAgentThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
			...
			String string = "AgentInternalThreshold already deleted";
			log("</br><b style='color:#02563d'>" + string + "</b>");
		}
		return false;
	}

	public boolean verifyAgentInternalThresholdDeleted(Map<Object, Object> map, List<Object> keys) {
		if (verifyFilterBtn()) {
	 ...
	 * @return true if AgentInternalThreshold Log successfully Verified
	 */
	public boolean verifyAgentInternalThresholdLog(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(12)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
	...
	/**
	 * @author dishant.doshi to sort agent internal threshold
	 * @param map
	 *            - for excel data
	 * @param mapKeys
	 *            - for excel header
