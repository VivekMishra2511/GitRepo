...
public class MerchantReportTerminalOnboardingDetailWeb extends Common{
	 ...
	 */
	public MerchantReportTerminalOnboardingDetailWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days Terminal Onboarding Detail
	 * @creation date 18/12/2018
	 */
	public void searchTerminalOnboardingDetail() {
		sendTextInStartDate();
		sendTextInEndDate();
	 ...
	 * @creation date 18/12/2018
	 */
	public boolean verifysearchTerminalOnboardingDetail(){
