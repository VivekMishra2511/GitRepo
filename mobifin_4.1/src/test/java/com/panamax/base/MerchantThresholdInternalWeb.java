...
public class MerchantThresholdInternalWeb extends Common {
	...
	public MerchantThresholdInternalWeb(WebDriver driver) {
		this.driver = driver;
	}

	/**
	 * @author kutbuddin.compounder send text in Merchant Internal Threshold
	 *         productName field
	 * @param productName
	 * @creation date 13/11/2018
	 */
	...
	/**
	 * @author kutbuddin.compounder select value from Merchant-Threshold
	...
	/**
	 * @author kutbuddin.compounder send text in Merchant Threshold Internal
	 ...
	 */
	public void filterSearch(String thresholdName, String serviceName, String profileName, String status) {
		commonFilterSearch();
	...
	/**
	 * @author kutbuddin.compounder to add Merchant-Threshold Internal
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 13/11/2018
	 */
	public void addMerchantThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		...
		if (!verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			...
			if (!map.get(keys.get(4)).toString().isEmpty()) {
				selectTreeName(map.get(keys.get(4)).toString());
				selectTreeLevel(map.get(keys.get(5)).toString());
			}
			selectProfileName(map.get(keys.get(2)).toString());
			selectStatus(map.get(keys.get(3)).toString());
			String[] nonKyctransactionCount = map.get(keys.get(6)).toString().split(":");
			String[] nonKyctransactionValue = map.get(keys.get(7)).toString().split(":");
			String[] mediumKyctransactionCount = map.get(keys.get(8)).toString().split(":");
			String[] mediumKyctransactionValue = map.get(keys.get(9)).toString().split(":");
			String[] fullKyctransactionCount = map.get(keys.get(10)).toString().split(":");
			String[] fullKyctransactionValue = map.get(keys.get(11)).toString().split(":");
	...
	/**
	 * @author kutbuddin.compounder to Edit Merchant-Threshold Internal
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 13/11/2018
	 */
	public void editMerchantThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
			clickOnEditBtn();
			selectStatus(map.get(keys.get(12)).toString());
			String[] nonKyctransactionCount = map.get(keys.get(6)).toString().split(":");
			String[] nonKyctransactionValue = map.get(keys.get(7)).toString().split(":");
			String[] mediumKyctransactionCount = map.get(keys.get(8)).toString().split(":");
			String[] mediumKyctransactionValue = map.get(keys.get(9)).toString().split(":");
	 ...
	 *            - excel header
	 * @creation date 13/11/2018
	 * @return true if Merchant Internal Threshold added successfully
	 */
	public boolean verifyMerchantThresholdInternalAdded(Map<Object, Object> map, List<Object> keys) {
		...
		By treeName = By.xpath(" //label[normalize-space(text())='" + ConstantsFile.TREE
				+ "']//following-sibling :: div[contains(text() , '" + map.get(keys.get(4)).toString() + "')]");
		By treeLevel = By.xpath(" //label[normalize-space(text())='" + ConstantsFile.TREE_LEVEL
				+ "']//following-sibling :: div[contains(text() , '" + map.get(keys.get(5)).toString() + "')]");
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
	 ...
	 *            - excel header
	 * @creation date 13/11/2018
	 * @return true if Merchant Internal Threshold edited successfully
	 */
	public boolean verifyMerchantThresholdInternalEdited(Map<Object, Object> map, List<Object> keys) {
		By thresholdName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.THRESHOLD_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(0)).toString() + "']");
		By profileName = By.xpath("//label[normalize-space(text())='" + ConstantsFile.PROFILE_NAME
				+ "']//following-sibling :: div[normalize-space(text()) = '" + map.get(keys.get(2)).toString() + "']");
	...
	/**
	 * @author Kutbuddin.compounder to verify MerchantInternalThreshold deleted?
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 13/11/2018
	 * @return true if MerchantInternalThreshold deleted successfully
	 */
	public boolean deleteMerchantThresholdInternal(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(3)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
			...
			String string = "MerchantInternalThreshold already deleted";
			log("</br><b style='color:#02563d'>" + string + "</b>");
		}
		return false;
	}

	public boolean verifyMerchantInternalThresholdDeleted(Map<Object, Object> map, List<Object> keys) {
		if (verifyFilterBtn()) {
	...
	/**
	 * @author kutbuddin.compounder to verify customer threshold log
	 * @param map
	 *            - excel values
	 * @param keys
	 *            - excel header
	 * @creation date 17/12/2018
	 * @return true if MerchantInternalThreshold Log successfully Verified
	 */
	public boolean verifyMerchantInternalThresholdLog(Map<Object, Object> map, List<Object> keys) {
		filterSearch(map.get(keys.get(0)).toString(), map.get(keys.get(1)).toString(), map.get(keys.get(2)).toString(),
				map.get(keys.get(12)).toString());
		if (verifyElement(By.xpath("(//td[text()='" + map.get(keys.get(0)).toString() + "'])[1]"), false)) {
			clickOnInfoBtn(map.get(keys.get(0)).toString());
	...
	/**
	 * @author dishant.doshi to sort merchant internal threshold
	 * @param map
	 *            - for excel data
	 * @param mapKeys
	 *            - for excel header
