...
public class ReportsUserBaseReportWeb extends Common{
	 ...
	 */
	public ReportsUserBaseReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days user base report
	 * @creation date 27/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify  user base report table
	 * @creation date 27/12/2018
	 */
	public boolean verifySearchUserBaseReport() {
