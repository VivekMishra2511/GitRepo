...
public class ReportsReversalDetailExternalServiceDetailReportWeb extends Common{
	 ...
	 */
	public ReportsReversalDetailExternalServiceDetailReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days Reversal Detail ExternalServiceDetailReport
	 * @creation date 24/12/2018
	 */
