...
public class ReportsTransactionDetailInternalServiceDetailReportWeb extends Common{
	 ...
	 */
	public ReportsTransactionDetailInternalServiceDetailReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days transaction details InternalServiceDetailReport
	 * @creation date 24/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify InternalServiceDetailReport table
	 * @creation date 24/12/2018
	 */
	public boolean verifysearchInternalServiceDetailReport() {
