...
public class ReportsTransactionDetailExternalServiceDetailReportWeb extends Common{
	 ...
	 */
	public ReportsTransactionDetailExternalServiceDetailReportWeb(WebDriver driver) {
		this.driver = driver;
	}
	/**
	 * @author shivani.doshi
	 ...
	 * Search last 30 days transaction details ExternalServiceDetailReport
	 * @creation date 24/12/2018
	 */
	...
	/**
	 * @author shivani.patel 
	 * Use for verify ExternalServiceDetailReport table
	 * @creation date 24/12/2018
	 */
	public boolean verifysearchExternalServiceDetailReport() {
